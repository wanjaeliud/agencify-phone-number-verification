...
public class CountryDataUtil {
    ...
    public CountryDto validateNumber(Country country) {
        ...
        countryDto.setState(checkValidity(country.getPhone()));
        countryDto.setCountry(determineCountry(country.getPhone()));
        countryDto.setPhone(country.getPhone());
        return countryDto;
    }


    public String checkValidity(String phoneNumber) {
